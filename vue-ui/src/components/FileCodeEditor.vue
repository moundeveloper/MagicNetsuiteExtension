<template>
  <div ref="container" class="file-code-editor"></div>
</template>
...
const nordTheme = EditorView.theme(
  {
    ...
    ".cm-content": { caretColor: "#D8DEE9", padding: "8px 0" },
    ...
    ".cm-lineNumbers .cm-gutterElement": { padding: "0 10px", minWidth: "40px" },
    ".cm-activeLineGutter": { backgroundColor: "#3B4252", color: "#7B8BA0" },
    ...
    ".cm-content ::selection": { backgroundColor: "#4C566A !important" },
    ".cm-selectionMatch": { backgroundColor: "#3B4252", outline: "1px solid #4C566A" },
    ".cm-matchingBracket, .cm-nonmatchingBracket": {
      backgroundColor: "#434C5E",
      outline: "1px solid #616E88"
    },
    ".cm-foldGutter .cm-gutterElement": { cursor: "pointer", color: "#4C566A" },
    ".cm-foldGutter .cm-gutterElement:hover": { color: "#81A1C1" },
    ".cm-scroller::-webkit-scrollbar": { width: "8px", height: "8px" },
    ".cm-scroller::-webkit-scrollbar-track": { background: "#2E3440" },
    ".cm-scroller::-webkit-scrollbar-thumb": { background: "#434C5E", borderRadius: "4px" },
    ".cm-scroller::-webkit-scrollbar-thumb:hover": { background: "#4C566A" }
  },
  { dark: true }
);
