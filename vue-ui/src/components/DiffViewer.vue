...
const baseTheme = EditorView.theme({
  ...
  ".cm-deletedChunk": { background: "rgba(239,68,68,0.15)" },
  ".cm-insertedChunk": { background: "rgba(34,197,94,0.15)" },
  ".cm-deletedLine": { background: "rgba(239,68,68,0.22)" },
  ".cm-insertedLine": { background: "rgba(34,197,94,0.22)" },
  ".cm-changedLine": { background: "rgba(59,130,246,0.12)" }
});
