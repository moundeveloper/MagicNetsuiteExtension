...
export function createServer(): McpServer {
  ...
  server.registerTool("magic_netsuite_template_session_get_current", {
    ...
    description:
      "Load current collaborative metadata, references, record context, render status, revisions, and active fix-request todos. Checked history and full FreeMarker are omitted by default.",
    inputSchema: {
