...
const openDashboard = async (button: HTMLButtonElement) => {
...
const addDashboardButton = (menuItemSpan: HTMLElement) => {
...
const addLogo = () => {
  const menuItemSpan = document.querySelector<HTMLElement>(
